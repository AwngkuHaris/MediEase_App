...
class _SignInPageState extends State<SigninPage> {
  ...
  try {
    ...
    if (userCredential != null) {
      ...
      final role = userData?['role']; // Assumes 'role' field exists in Firestore
      ...
      if (role == 'admin') {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => MainPage(isSignedIn: true), // Navigate to User MainPage
          ),
        );
      } else {
  ...
  return Scaffold(
    body: Stack(
      children: [
        Positioned.fill(
          child: Image.asset(
            'assets/images/login.jpeg', // Background image
            fit: BoxFit.cover,
          ),
        ),
        Positioned.fill(
          child: Container(
            color: Colors.white.withAlpha(170), // White overlay
          ),
        ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildTextFieldSection("Email Address", _emailController, false),
                const SizedBox(height: 16),
                _buildTextFieldSection("Password", _passwordController, true),
